...
"""reponse = requests.get("https://codeavecjonathan.com/res/pizzas1.json") # type: ignore
...
reponse = requests.get("https://codeavecjonathan.com/res/exemple.html") # type: ignore
if reponse.status_code == 200:
    reponse.encoding = "utf-8"
    print(reponse.text)
else:
